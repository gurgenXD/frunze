"""
Django settings for frunze project.
...
SECRET_KEY = '4=9l^@ctz!3hhemdpe@cd1th1-m%_@c+2zryxr!qc!)^tex8#e'
...
WSGI_APPLICATION = 'frunze.wsgi.application'
